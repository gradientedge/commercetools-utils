...
describe('CommercetoolsApi', () => {
  ...
  describe('OrderEdit', () => {
    ...
    describe('addStagedActionsToOrderEditById', () => {
      it('should make a POST request to the correct endpoint with a single staged action', async () => {
        const expectedResponse = { id: 'test-order-edit', version: 2 }
        const singleStagedAction = { action: 'setCustomerEmail', email: 'test@example.com' } as const
        ...
        nock('https://api.europe-west1.gcp.commercetools.com', {
          ...
          .post('/test-project-key/orders/edits/spoof-path%2Fmy-order-edit-id', {
            version: 1,
            actions: [
              {
                action: 'addStagedAction',
                stagedAction: singleStagedAction,
              },
            ],
          })
        ...
        const result = await api.addStagedActionsToOrderEditById({
          id: 'spoof-path/my-order-edit-id',
          version: 1,
          stagedActions: [singleStagedAction],
        })

        expect(result).toEqual(expectedResponse)
      })

      it('should make a POST request to the correct endpoint with multiple staged actions', async () => {
        const expectedResponse = { id: 'test-order-edit', version: 2 }
        const stagedActions = [
          { action: 'setCustomerEmail', email: 'test@example.com' },
        ...
        nock('https://api.europe-west1.gcp.commercetools.com', {
          ...
          .post('/test-project-key/orders/edits/spoof-path%2Fmy-order-edit-id', {
            ...
            actions: [
              {
                action: 'addStagedAction',
                stagedAction: stagedActions[0],
              },
              {
                action: 'addStagedAction',
                stagedAction: stagedActions[1],
              },
              {
                action: 'addStagedAction',
                stagedAction: stagedActions[2],
              },
            ],
          })
          .reply(200, expectedResponse)
      ...
      it('should throw an error when an empty ID is being passed as a parameter', async () => {
        ...
        await expect(() =>
          api.addStagedActionsToOrderEditById({
            id: ' ',
            version: 1,
            stagedActions: [{ action: 'setCustomerEmail', email: 'test@example.com' } as const],
          }),
        ).toThrow(`The string parameter 'id' cannot be empty`)
      })
    })

    describe('addStagedActionsToOrderEditByKey', () => {
      it('should make a POST request to the correct endpoint with a single staged action', async () => {
        const expectedResponse = { id: 'test-order-edit', version: 2 }
        const singleStagedAction = { action: 'setCustomerEmail', email: 'test@example.com' } as const
        ...
        nock('https://api.europe-west1.gcp.commercetools.com', {
          ...
          .post('/test-project-key/orders/edits/key=my-order-edit-key', {
            version: 1,
            actions: [
              {
                action: 'addStagedAction',
        ...
        const result = await api.addStagedActionsToOrderEditByKey({
          key: 'my-order-edit-key',
          version: 1,
          stagedActions: [singleStagedAction],
        })
    ...
    describe('setStagedActionsForOrderEditById', () => {
      it('should make a POST request to the correct endpoint with a single staged action', async () => {
        const expectedResponse = { id: 'test-order-edit', version: 2 }
        const singleStagedAction = { action: 'setCustomerEmail', email: 'test@example.com' } as const
        ...
        const result = await api.setStagedActionsForOrderEditById({
          id: 'spoof-path/my-order-edit-id',
          version: 1,
          stagedActions: [singleStagedAction],
        })
      ...
      it('should throw an error when an empty ID is being passed as a parameter', async () => {
        ...
        await expect(() =>
          api.setStagedActionsForOrderEditById({
            id: ' ',
            version: 1,
            stagedActions: [{ action: 'setCustomerEmail', email: 'test@example.com' } as const],
          }),
    ...
    describe('setStagedActionsForOrderEditByKey', () => {
      it('should make a POST request to the correct endpoint with a single staged action', async () => {
        const expectedResponse = { id: 'test-order-edit', version: 2 }
        const singleStagedAction = { action: 'setCustomerEmail', email: 'test@example.com' } as const
        ...
        const result = await api.setStagedActionsForOrderEditByKey({
          key: 'my-order-edit-key',
          version: 1,
          stagedActions: [singleStagedAction],
        })
      ...
      it('should throw an error when an empty key is being passed as a parameter', async () => {
        ...
        await expect(() =>
          api.setStagedActionsForOrderEditByKey({
            key: ' ',
            version: 1,
            stagedActions: [{ action: 'setCustomerEmail', email: 'test@example.com' } as const],
          }),

 ...
 *
 */
export type QuoteState = 'Accepted' | 'Declined' | 'Failed' | 'Pending' | 'Withdrawn'
...
export type QuoteUpdateAction = QuoteChangeQuoteStateAction | QuoteSetCustomFieldAction | QuoteSetCustomTypeAction
